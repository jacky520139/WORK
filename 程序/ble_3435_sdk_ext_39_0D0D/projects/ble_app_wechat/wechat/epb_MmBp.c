...
BaseResponse *epb_unpack_base_response(const uint8_t *buf, int buf_len)
{
	...
	BaseResponse *response = (BaseResponse *)ke_malloc(sizeof(BaseResponse),KE_MEM_KE_MSG);
...
BasePush *epb_unpack_base_push(const uint8_t *buf, int buf_len)
{
	...
	BasePush *push= (BasePush *)ke_malloc(sizeof(BasePush),KE_MEM_KE_MSG);
...
int epb_pack_auth_request(AuthRequest *request, uint8_t *buf, int buf_len)
{
	...
	tmp = (uint8_t *)ke_malloc(tmp_len,KE_MEM_KE_MSG);
...
AuthResponse *epb_unpack_auth_response(const uint8_t *buf, int buf_len)
{
	...
	AuthResponse *response = (AuthResponse *)ke_malloc(sizeof(AuthResponse), KE_MEM_KE_MSG);
...
InitResponse *epb_unpack_init_response(const uint8_t *buf, int buf_len)
{
	...
	InitResponse *response = (InitResponse *)ke_malloc(sizeof(InitResponse), KE_MEM_KE_MSG);
...
SendDataResponse *epb_unpack_send_data_response(const uint8_t *buf, int buf_len)
{
	...
	SendDataResponse *response = (SendDataResponse *)ke_malloc(sizeof(SendDataResponse),KE_MEM_KE_MSG);
...
RecvDataPush *epb_unpack_recv_data_push(const uint8_t *buf, int buf_len)
{
	...
	RecvDataPush *push = (RecvDataPush *)ke_malloc(sizeof(RecvDataPush),KE_MEM_KE_MSG);
...
SwitchViewPush *epb_unpack_switch_view_push(const uint8_t *buf, int buf_len)
{
	...
	SwitchViewPush *push = (SwitchViewPush *)ke_malloc(sizeof(SwitchViewPush),KE_MEM_KE_MSG);
...
SwitchBackgroudPush *epb_unpack_switch_backgroud_push(const uint8_t *buf, int buf_len)
{
	...
	SwitchBackgroudPush *push = (SwitchBackgroudPush *)ke_malloc(sizeof(SwitchBackgroudPush),KE_MEM_KE_MSG);
