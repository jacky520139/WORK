...
uint8_t tDevice_Name[]=
{
	'B','K','3','4','3','5','_','M','o','u','s','e'
};

uint8_t appm_get_dev_name(uint8_t* name)
{
	// copy name to provided pointer
	app_env.dev_name_len =	sizeof(tDevice_Name);
	memcpy(app_env.dev_name, tDevice_Name, sizeof(tDevice_Name));
	memcpy(name, tDevice_Name, sizeof(tDevice_Name));
