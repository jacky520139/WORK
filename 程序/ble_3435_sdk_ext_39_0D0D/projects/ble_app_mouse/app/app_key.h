...
#define BK3435_DEMO_KIT			0
#define BK3435_BELON_BOARD		1
#define BK3435_HBG_BOARD		0
...
//mouse
#define WheelA		GPIOB_0
#define WheelB		GPIOB_1

#define Key_R		GPIOB_4
#define Key_M		GPIOB_5
#define Key_L		GPIOB_6
#define Key_P		GPIOB_7

#define MOUSE_KEY_LEN	4

#define Sensor_SDIO		GPIOD_0
#define Sensor_SCK		GPIOD_1
#define Sensor_MOTSWK	GPIOD_4

#define MOUSE_INT_LEN	7
...
//mouse end
#define Mouse_LedPort		GPIOC_6
#define	Mouse_LedOn()		REG_APB5_GPIOC_DATA |= 0x40
#define	Mouse_LedOff()		REG_APB5_GPIOC_DATA &= (~0x40)
#define	Mouse_LedToggle()	REG_APB5_GPIOC_DATA ^= 0x40
