...
//最小连接间隔
#define BLE_UAPDATA_MIN_INTVALUE		160//必须是“0.625ms”的整数倍
//最大连接间隔 
#define BLE_UAPDATA_MAX_INTVALUE		320//必须是“0.625ms”的整数倍
//连接Latency
#define BLE_UAPDATA_LATENCY				2
//连接超时
#define BLE_UAPDATA_TIMEOUT				2000
...
extern unsigned char APP_DFLT_DEVICE_NAME[DEVICE_NAME_LEN];
...
#define APP_SCNRSP_DATA_LEN     DEVICE_NAME_LEN+2
extern unsigned char APP_SCNRSP_DATA[APP_SCNRSP_DATA_LEN];
//广播参数配置
