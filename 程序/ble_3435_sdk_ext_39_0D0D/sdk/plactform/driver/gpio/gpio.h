...
#define	RedLedOn()		REG_APB5_GPIOB_DATA |= 0x04
#define	RedLedOff()		REG_APB5_GPIOB_DATA &= (~0x04)
#define	RedLedToggle()	REG_APB5_GPIOB_DATA ^= 0x04

#define TextPort      0x06
#define	TextPortToggle()	REG_APB5_GPIOA_DATA ^= 0x40
