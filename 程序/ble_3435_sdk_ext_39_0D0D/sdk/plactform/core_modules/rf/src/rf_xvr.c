...
void init_analog_xvr_reg(void)
{
	...
	if((system_mode & RW_DUT_MODE) == RW_DUT_MODE)
	{
		...
		mHWreg_Assign_XVR_Regsiter(04, 0x7F915f33);// 0x5F915727
		XVR_ANALOG_REG_BAK[0x04] = 0x7F915f33;
	...
	else
	{
		...
		mHWreg_Assign_XVR_Regsiter(04, 0x7F935eb7);// 0x5F915727  1017
		XVR_ANALOG_REG_BAK[0x04] = 0x7F935eb7;
